...
#SBATCH --output=classify_phi3Value.out

# Set the file for error log (stderr)
#SBATCH --error=classify_phi3Value.err
...
matlab -nodisplay -nosplash -nodesktop -r "main_classify_phi3Value; exit"
