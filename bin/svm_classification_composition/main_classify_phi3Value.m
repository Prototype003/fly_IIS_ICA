...
% Same format as when using big_mip
% concepts x sets x trials x flies x conditions
% concepts (1) x sets x trials x flies x conditions
big_mips = permute(phis.phis, [5 1 2 3 4]);
...
class_type = 'within';
results_file = [num2str(nChannels) 'ch_phi3Value_svm_' class_type '.mat'];
