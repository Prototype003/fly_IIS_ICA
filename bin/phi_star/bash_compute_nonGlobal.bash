...
#SBATCH --output=logs/phi_star_nonGlobal.out

# Set the file for error log (stderr)
#SBATCH --error=logs/phi_star_nonGlobal.err
...
matlab -nodisplay -nodesktop -r "cd phi_star/; main_compute_nonGlobal; exit"
