...
channel_data_file = "channelMeanPhis_globalTPM" + str(global_tpm) + "_tau" + str(tau) + ".mat"

# Output location
results_directory = "results_phiChain_split_accuracy/"
...
channel_means = loaded_data['channel_means'][channel_mean_nChannels, 0]['accuracies'][0, 0][:, fly-1] # These are mean accuracy per channel
